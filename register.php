<?php
    ...
    if(isset($_POST["register"])) {
       ...
       if(empty($name) or empty($email) or empty($username) or empty($password)) {
            echo "<div class='alert alert-danger mb-0 text-center'>Bosh ola bilmez!</div>";
            return;
       ...
       if(!is_null($user)) {
        echo "<div class='alert alert-danger mb-0 text-center'>Username daha evvel istifade olunub!</div>";
        return;
